...
$blog_data_path = ASSETS . '/src/data.php';
            ...
            ?>
              <div class="swiper-slide">
                <a class="top-voice__link" href="../result/details.php">
                  <div class="top-voice__image"><img class="top-voice__img img-100" src="<?= ASSETS_URI ?>/img/result/<?= $value['src'] ?>" alt="<?= $value['name'] ?>" width="335" height="200" loading="lazy"></div>
            ...
            <a class="top-blog__card card" href="../blog/details.php">
              <div class="card__image-box">
                <div class="card__image">
                  <picture>
                    <source srcset="<?= ASSETS_URI ?>/img/blog/<?= $value['src'] ?>-pc.jpg" media="(min-width: 768px)">
                    <img class="card__img img-100" src="<?= ASSETS_URI ?>/img/blog/<?= $value['src'] ?>-sp.jpg" alt="" width="335" height="200" loading="lazy">
                  </picture>
                </div>
